defmodule LivrariaWeb.ProductController do
  ...
  def new(conn, _params) do
    ...
    render(conn, "new.html", changeset: changeset, suppliers: suppliers)
  end
  ...
  def create(conn, %{"product" => product_params}) do
    case Catalog.create_product(product_params) do
      ...
      {:error, %Ecto.Changeset{} = changeset} ->
        render(conn, "new.html", changeset: changeset, suppliers: Catalog.list_suppliers())
    end
  end
