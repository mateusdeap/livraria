defmodule LivrariaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LivrariaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LivrariaWeb.Gettext, "errors", msg, opts)
    end
  end
